...
enum {STAND_INIT, STANDING, WALKING};
...
//  robotis_framework::FifthOrderPolynomialTrajectory* b= new robotis_framework::FifthOrderPolynomialTrajectory(0,0,0,0,T,-0.2,0,0);
